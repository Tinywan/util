...
class Arr
{
     ...
     * @return array
     */
    public static function flatten(array $array, int $depth): array
    {
        $result = [];
     ...
     * @return array
     */
    public static function getRowsByArray(array $array, string $row): array
    {
        $result = [];
        foreach ($array as $value) {
            $result[] = $value[$row];
     ...
     * @param string $row 键名
     */
    public static function getArrayByRows(array $array, string $row): array
    {
        $result = [];
        foreach ($array as $value) {
     ...
     * @return array
     */
    public static function getArrayByKey(array $array, string $key1, string $key2): array
    {
        $result = [];
        foreach ($array as $value) {
